      ...
      <View style={listItemStyles.rightBox}>
        <View>
          <Text style={listItemStyles.coinName}>
            ${item?.market_data?.price_usd.toLocaleString(undefined, {maximumFractionDigits: 6})}
          </Text>
          <Text style={listItemStyles.coinHealth}>
            <Image
              style={listItemStyles.healthImg}
              source={item?.market_data?.percent_change_usd_last_24_hours > 0 ? buyArrow : sellArrow}
            />
            <Text
              style={
